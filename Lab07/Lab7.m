...
Vb2=block(V',bsize);
figure; imshow(cell2mat(Vb2),[]); title('KLT coefficients');
for k=1:bsize-1
...
%N.B.: instad of taking the values from the matrix Vb2 i use the raws of V
%that is more easy! I obtain the same values of the eigenvalues!!!
